...
class Ariana_Nav_Menu_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'description' => __( '(Ariana) Add a nav menu to your sidebar.' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'ariana_nav_menu', __('Ariana Navigation Menu'), $widget_ops );
	}
    ...
    $ul_class = isset( $instance['ul_class'] ) ? $instance['ul_class'] : '';
      ...
      <p>
				<label for="<?php echo $this->get_field_id( 'container_class' ); ?>"><?php _e( 'Container Class:' ) ?></label>
      ...
      <p>
				<label for="<?php echo $this->get_field_id( 'ul_class' ); ?>"><?php _e( 'UL Class:' ) ?></label>
