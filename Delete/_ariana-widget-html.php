 ...
 * @see WP_Widget
 */
class Ariana_Widget_Custom_HTML extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'ariana_custom_html', __( 'Ariana Custom HTML' ), $widget_ops, $control_ops );
	}
	...
	public function _register_one( $number = -1 ) {
		...
		add_action( 'admin_footer-widgets.php', array( 'Ariana_Widget_Custom_HTML', 'render_control_template_scripts' ) );

		// Note this action is used to ensure the help text is added to the end.
		add_action( 'admin_head-widgets.php', array( 'Ariana_Widget_Custom_HTML', 'add_help_text' ) );
	}
