...
class Ariana_Widget_Text extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'ariana_text', __( 'Ariana Text' ), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 */
		$widget_text_do_shortcode_priority = has_filter( 'ariana_widget_text', 'do_shortcode' );
		$should_suspend_legacy_shortcode_support = ( $is_visual_text_widget && false !== $widget_text_do_shortcode_priority );
		if ( $should_suspend_legacy_shortcode_support ) {
			remove_filter( 'ariana_widget_text', 'do_shortcode', $widget_text_do_shortcode_priority );
		}
		 ...
		 */
		$text = apply_filters( 'ariana_widget_text', $text, $instance, $this );
