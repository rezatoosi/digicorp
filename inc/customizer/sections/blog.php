<?php
// Set prefix
$prefix = 'digicorp' . '_sections_blog'; // digicorp_sections_blog

/******************* Section *******************/

$wp_customize->add_section( $prefix, array(
	'title'       => __( 'Blog Section', 'digicorpdomain' ),
	'description' => __( 'Manage blog section settings.', 'digicorpdomain' ),
	'priority'    => 5,
...
$wp_customize->selective_refresh->add_partial( $prefix . '_title', array(
	'selector'        => '#section-blog .section-title > h3',
	'render_callback' => 'digicorp_customize_partial_sections_blog_title',
) );
...
$wp_customize->selective_refresh->add_partial( $prefix . '_subtitle', array(
	'selector'        => '#section-blog .section-title > h5',
	'render_callback' => 'digicorp_customize_partial_sections_blog_subtitle',
) );
